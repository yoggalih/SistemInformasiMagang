...
@section('content')
    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <p class="text-gray-600 mb-4">Anda dapat memeriksa status pendaftaran magang Anda secara real-time di sini.</p>
            <a href="{{ route('status.form') }}" class="inline-flex items-center text-blue-600 hover:text-blue-800 font-medium">
            ...
            <div class="bg-white p-6 rounded-lg shadow-lg border-t-4 border-gray-500">
                ...
                <p class="text-sm text-gray-500 mt-3">
                    *Catatan: Akun ini dibuat untuk mengakses fitur khusus. Data pendaftaran magang Anda (jika sudah submit)
                    terpisah dari akun ini.
                </p>
                {{-- Perbaikan: Menggunakan route('logout') --}}
